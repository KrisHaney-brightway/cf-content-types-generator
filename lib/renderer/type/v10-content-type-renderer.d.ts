...
export declare class V10ContentTypeRenderer extends BaseContentTypeRenderer {
    ...
    protected renderEntrySkeleton(contentType: CFContentType, context: RenderContext): OptionalKind<TypeAliasDeclarationStructure>;
