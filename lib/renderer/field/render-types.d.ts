...
export type FieldRenderer<FType extends ContentTypeFieldType> = (field: FType extends 'Link' ? Pick<ContentTypeField, 'validations' | 'linkType'> : ContentTypeField, context: RenderContext) => string;
